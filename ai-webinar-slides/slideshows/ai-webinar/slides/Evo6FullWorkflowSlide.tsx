  ...
  return (
    <Slide>
      ...
      <div className="flex gap-6 h-[calc(100vh-280px)]">
        {/* Left: diagram */}
        <div className="w-[65%] bg-[var(--bg-diagram)] rounded-xl p-2 border border-gray-100 flex items-center justify-center">
        ...
        <div className="w-[35%] flex flex-col relative">
          ...
          <div className="flex gap-3 mb-4">
            ...
            <div className="flex-1 content-card p-2 text-center">
              <div className="text-xl font-black text-pe-teal">11</div>
